...
- **Интерактивный (меню):** запустите **`roma-stt.bat`** без аргументов. Появится меню, рекомендуемый порядок: 1 → 2 → 3.
- **Командная строка:** **`roma-stt.bat <команда> [аргументы]`**:
  - `install-tools` — установка системных программ (входит в пункт 1).
...
- **5** — Подбор свободных горячих клавиш.
